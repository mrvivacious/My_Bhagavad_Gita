...
const HELP_REPROMPT = 'Say both a chapter number and a verse number, or ask to play a verse about a topic, or ask for a random verse.';
...
const handlers = {
  ...
  'LaunchRequest': function() {
    ...
    let launchText = 'Welcome to the Bhagavad Gita. You can ' +
    'request a verse by chapter and verse numbers, request a verse by topic, or ask for a random verse.';
  ...
  'VerseEnquiryIntent': function () {
    ...
    // Validate chapter and verse are defined
    if (chapterNumber && verseNumber) {
      // Ensure chapter, verse are within the Gita
